...
class Monthly extends Component
{
    ...
    public function mount(){
        $now=Carbon::now();
        $this->monthDate=$now->copy()->format('Y-m');
    ...
    public function render()
    {
        ...
        $this->dispatchBrowserEvent('monthlyChanged');
        return view('livewire.reports.housekeeping.monthly');
    }

    public function setdate($date){
        $date=Carbon::parse($date);
        $this->monthDate=$date->copy()->format('Y-m');
