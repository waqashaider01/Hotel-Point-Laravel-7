        ...
        <div class="card card-custom" style="background: transparent; margin:0px; padding: 0px;">
            ...
            <div class="container-fluid" style="background: transparent; margin:0px; padding: 0px;">
                ...
                <div id="iframecontainer" style="width: 100%; height: 100vh;">
                    ...
                    <!--------------------------- begin iframe ------------------------------>
                    <iframe id="inventoryframe" frameBorder="0" hspace="0" vspace="0"
            ...
            $.ajax({
                ...
                success: function(args) {
                    ...
                    var iframeRef = "https://staging.channex.io/auth/exchange?oauth_session_key=" +
                        accesstoken +
                        " &app_mode=headless&redirect_to=/inventory&property_id=" + propertyid;

                    $("#inventoryframe").attr("src", iframeRef);
