        ...
        <div class="container-fluid mb-10">
            <div class="listcard">
				<div class="" style="background-color:#48BBBE; margin-top:-2.1% !important;color:white; margin-bottom:15px;with:100%;margin-left:-2.1% !important;margin-right:-2.1%;border-radius:5px 5px 0px 0px;" >
		             <h2 class="pt-7 pl-3 pb-7"  >R&M Report</h2>
                </div>
                         ...
                         <div class="table-responsive">
                                <table  class="table " >
                                    ...
                                    <tr class="bg-white">
                                                ...
                                                <td class="idcolor">R&M Operating Expenses<div class="triangle-down-blue mt-2 " type="button" id="oemtd" style="float:right;" ></div></td>
                                    ...
                                    <tr class="bg-white">
                                                ...
                                                <td class="idcolor">Energy Costs<div class="triangle-down-blue mt-2 " type="button" id="ecmtd" style="float:right;" ></div></td>
                                                <td>{{showPriceWithCurrency($totalMtdActualEC)}}</td>
                                                <td>{{showPriceWithCurrency($totalMtdBudgetEC)}}</td>
                                                <td><i class="fas {{$totalmtdColor=='green'? 'fa-arrow-up':'fa-arrow-down' }} " style="color:{{$totalmtdColor}}"></i> {{$totalmtdValue}}%</td>
                                                
                                         </tr>
                                    @foreach($energyCostMTD as $mtd)
                                        <tr class="bg-white ecmonth opexall">
						 ...
						 <div class="table-responsive">
                                <table  class="table " >
                                    ...
                                    <tr class="bg-white">
                                                ...
                                                <td class="idcolor">R&M Operating Expenses<div class="triangle-down-blue mt-2 " type="button" id="oeytd" style="float:right;" ></div></td>
                                    ...
                                    <tr class="bg-white">
                                                ...
                                                <td class="idcolor">Energy Costs<div class="triangle-down-blue mt-2 " type="button" id="ecytd" style="float:right;" ></div></td>
                                                <td>{{showPriceWithCurrency($totalYtdActualEC)}}</td>
                                                <td>{{showPriceWithCurrency($totalYtdBudgetEC)}}</td>
                                                <td><i class="fas {{$totalytdColor=='green'? 'fa-arrow-up':'fa-arrow-down' }} " style="color:{{$totalytdColor}}"></i> {{$totalytdValue}}%</td>
                                                
                                         </tr>
                                    @foreach($energyCostYTD as $ytd)
                                        <tr class="bg-white ecyear opexall">
                                                
                                                    <td>{{$ytd[0]}}</td>
                                                    <td>{{showPriceWithCurrency($ytd[1])}}</td>
                                                    <td>{{showPriceWithCurrency($ytd[2])}}</td>
                                                    <td><i class="fas {{$ytd[3][1]=='green'? 'fa-arrow-up':'fa-arrow-down' }} " style="color:{{$ytd[3][1]}}"></i> {{$ytd[3][0]}}%</td>
...
<script>
    $(document).ready( function() {
        ...
        $("#ecytd").click(function(){
            $(".ecyear").toggle();
        });

        document.addEventListener("rmChanged", () => {
