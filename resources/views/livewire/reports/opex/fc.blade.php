        ...
        <div class="container-fluid mb-10">
            <div class="listcard">
				<div class="" style="background-color:#48BBBE; margin-top:-2.1% !important;color:white; margin-bottom:15px;with:100%;margin-left:-2.1% !important;margin-right:-2.1%;border-radius:5px 5px 0px 0px;" >
		             <h2 class="pt-7 pl-3 pb-7"  >Fixed Charge Report</h2>
                </div>
                         ...
                         <div class="table-responsive">
                                <table  class="table " >
                                    ...
                                    <tr class="bg-white">
                                                ...
                                                <td class="idcolor">Fixed Charge<div class="triangle-down-blue mt-2 " type="button" id="fcmtd" style="float:right;" ></div></td>
                                    ...
                                    @foreach($operatingExpenseMTD as $mtd)
                                        <tr class="bg-white fcmonth opexall">
						 ...
						 <div class="table-responsive">
                                <table  class="table " >
                                    ...
                                    <tr class="bg-white">
                                                ...
                                                <td class="idcolor">Fixed Charge<div class="triangle-down-blue mt-2 " type="button" id="fcytd" style="float:right;" ></div></td>
                                    ...
                                    @foreach($operatingExpenseYTD as $mtd)
                                        <tr class="bg-white fcyear opexall">
...
<script>
    $(document).ready( function() {
        ...
        $(".opexall").hide();
        $("#fcmtd").click(function(){
            $(".fcmonth").toggle();
        });
        $("#fcytd").click(function(){
            $(".fcyear").toggle();
        });
           
        document.addEventListener("fcChanged", () => {
