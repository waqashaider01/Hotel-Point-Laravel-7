        ...
        <div class="container-fluid">
	         ...
	         <div class="listcard " style="" >
                    <div class="" style="background-color:#48BBBE; margin-top:-2.1% !important;color:white; margin-bottom:15px;with:100%;margin-left:-2.1% !important;margin-right:-2.1%;border-radius:5px 5px 0px 0px;" >
                          <h2 class="pt-7 pl-3 pb-7" >Bank Transfer Report</h2> 
                    </div>
                    <div class='row'>
                            <div class='col-md-5'>
                                    <table>
            ...
            <div class="row">
                    <div class="col">
                            <div class="listcard listcard-custom mt-10 " style="height:350px;" >
                                    <div id="bankchart" style="width: 100%; height: 100%;"></div>
                            </div>
                    </div>
            </div>
                        ...
                        <table  class="table " >
                            ...
                            <tbody id="tabbody">
                                ...
                                <tr class="text-center bg-white">
                                        ...
                                        <td class="idcolor">Bank Transfer</td>
...
<script type="text/javascript">
        $(document).ready(function(){
            fetch("{{route('getMinDate')}}").then(result=> result.json()).then(json => show1(json))
                ...
                document.addEventListener("bankChanged", () => {
        ...
        function populateChart(chartdata){
            ...
            function drawChart(){
                             ...
                             var chart = new google.visualization.ComboChart(document.getElementById('bankchart'));
