    ...
    <div class="container-fluid">
          <div class="listcard " >
         	<div class="" style=" background-color:#48BBBE;margin-top:-2.1% !important;color:white; margin-bottom:15px;with:100%;margin-left:-2.1% !important;margin-right:-2.1%;border-radius:5px 5px 0px 0px;" >
		       <h2 class="pt-7 pl-3 pb-7" >Country Report</h2>
      ...
      <div wire:ignore class="row">
            <div class="col">
                   <div class="listcard listcard-custom mt-10 " style="height:350px;" >
                        <div id="country_chart" style="width: 100%; height: 100%;"></div>
                   </div>
             </div>
	   </div>
                ...
                <table  class="table " >
                    ...
                    @forelse($guests as $guest)
                        <tr class="text-center thin-bottom-border bg-white">
                                ...
                                <td><div class="idcolor" >{{$guest[0]}}</div></td>
                                <td>{{$guest[1]}}</td>
...
function populateChart(chartdata){
          ...
          function drawChart() {
            ...
            var chart = new google.visualization.AreaChart(document.getElementById('country_chart'));
