<div>
                    ...
                    <div class="tax_settings shadow-sm bg-white">
                        ...
                        <div class="row">
                            ...
                            <div class="col-5">
                                <div class="row">
                                    <div class="col-8">
                                        <label>Sender E-mail</label></br>
                                        <span class="font-weight-bold">{{ $email->email }}</span>
                                    </div>
                                    <div class="col-4">
                                        <label>Notifications Receiver E-mail</label></br>
                                        <span
                                            class="font-weight-bold">{{ $email->notification_receiver_email }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-2 text-right">
                                <i class="fas fa-edit fa-2x" data-toggle="modal" data-target="#editEmail"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-10 m-0" style="margin-bottom:50%;">
                <div class="col p-0">
                    <form class="infocard shadow-sm bg-white" wire:submit.prevent="saveTemplate">
                        <div class="row">
                            <div class="col-11">
                                <h1 style="margin-left:12%;">New Email Template</h1>
                            </div>
                            <div class="col-1">
                            </div>
                        </div>
   ...
   line-height:2em; margin: 10px 0 10px; margin-top:2em; margin-bottom:2em;
    background-size: 600% 400%;">
            ...
            {{-- Modal --}}
            <div class="modal fade" id="editEmail" style="border-radius:0px !important;" tabindex="-1"
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content rounded-0">
                        <div class="modal-header shadow-sm " style="border-radius:0px !important;z-index:10;">
                            <h5 style="margin-left:42%;margin-right:23%;" class="modal-title text-dark"
                                id="exampleModalLabel">
                                Email Settings</h5>
                            <button type="submit" wire:click="saveEmail"
                            ...
                            <div class="form-style-6">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="email" wire:model.defer="email.email" placeholder="Enter Email" />
                                        <x-error field="email.email" />
                                    </div>
                                    <div class="col">
                                        <label>Notifications Receiver E-mail</label>
                                        <input type="email" wire:model.defer="email.notification_receiver_email"
                                            placeholder="Enter Receiver Email" />
                                        <x-error field="email.notification_receiver_email" />
                                    </div>
                                </div>
                            </div>
                        </div>
